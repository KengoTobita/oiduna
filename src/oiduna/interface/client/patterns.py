...
import httpx
from oiduna.interface.client.models import (
    PatternSubmitRequest,
    PatternSubmitResponse,
    PatternValidateResponse,
    ActivePatternsResponse,
)
from oiduna.interface.client.exceptions import OidunaAPIError, ValidationError, TimeoutError as OidunaTimeoutError
