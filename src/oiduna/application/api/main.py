...
from oiduna.application.api.config import settings
from oiduna.application.api.dependencies import get_container
from oiduna.application.api.extensions import discover_extensions
from oiduna.application.api.routes import assets, dashboard, midi, playback, stream, auth, session, tracks, patterns, admin, timeline
from oiduna.application.api.services.loop_service import LoopService, get_loop_service, lifespan
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "oiduna.application.api.main:app",
