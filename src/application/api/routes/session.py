...
from oiduna.application.api.dependencies import get_container, get_loop_service
from oiduna.application.api.services.loop_service import LoopService
...
async def get_config(
    ...
    """
    from oiduna.infrastructure.execution.constants import LOOP_STEPS
    ...
    clients = [
        ...
        for client in container.clients.list_clients()
    ]
