...
from oiduna_loop.ipc import InProcessStateProducer

# InProcessStateProducer は SessionEventPublisher Protocol を実装
publisher = InProcessStateProducer()
...
### InProcessStateProducer が両方のProtocolを実装（v3.1）

```python
# InProcessStateProducer は2つの役割を担当
...
### Q5: InProcessStateProducer が両方のProtocolを実装する理由は？
