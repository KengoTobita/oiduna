...
| [0022](./0022-schedule-cued-terminology-separation.md) | Schedule/Cued Terminology Separation | 2026-03-11 | Schedule（確定実行計画）とCued（未来予約）の明確な分離、50ファイル改名 |
| [0023](./0023-unified-4-layer-architecture.md) | Unified 4-Layer Architecture | 2026-03-12 | 9パッケージ→統合4層、v1.0初回公開、クリーンアップ完了、370テスト成功 |
| [0024](./0024-phase1-code-quality-improvements.md) | Phase 1 Code Quality Improvements - DRY and Template Method Pattern | 2026-03-12 | バリデーション共通化、Template Method Pattern適用、英語統一、コード重複75-80%削減 |
| [0025](./0025-phase2-manager-error-handling.md) | Phase 2 Code Quality - Manager Error Handling Standardization | 2026-03-13 | Replace Error Code with Exceptionパターン適用、PatternManager例外ベース化、型安全性向上 |
| [0026](./0026-phase2-loop-engine-extraction.md) | Phase 2 Code Quality - LoopEngine Service Extraction | 2026-03-13 | Extract Classパターン適用、3サービス抽出（DriftCorrector/ConnectionMonitor/HeartbeatService）、145行削減、SRP準拠 |
| [0027](./0027-repository-service-pattern-separation.md) | Repository/Service Pattern Separation | 2026-03-15 | Repository層（CRUD）とService層（ビジネスロジック）の分離、149テスト追加、テスタビリティ向上、トランザクション制御 |
| [0028](./0028-phase-d2-step-executor-extraction.md) | Phase D2 - StepExecutor Service Extraction | 2026-03-15 | Extract Classパターン適用、5段階パイプライン抽出、LoopEngine 928→841行（-9.4%）、100%カバレッジ、Phase 2パターン準拠 |
| [0029](./0029-test-coverage-enhancement.md) | Test Coverage Enhancement to 70% | 2026-03-16 | 5フェーズ実装、57%→70%カバレッジ、602テスト追加、IPC/Transport/Validators強化、境界値106+テスト、負荷・E2Eインフラ整備、本番環境準備完了 |
