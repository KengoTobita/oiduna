...
| [0013](./0013-distribution-oiduna-terminology-mapping.md) | Distribution-Oiduna Terminology Mapping Strategy | 2026-03-21 | Distribution用語（Start/Pitch/Length/Velocity）とOiduna用語（step/note/velocity/duration_ms）の対応、Distribution側で変換 |
